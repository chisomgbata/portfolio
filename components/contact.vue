    ...
    <form class="" @submit.prevent="handleSubmit">
      ...
      <div class="flex flex-col gap-12 mt-14">
        ...
        <div class="relative">
          ...
          <label
            for="message"
            class="absolute left-0 -top-3.5 text-gray-600 text-sm transition-all peer-placeholder-shown:text-base duration-500 peer-placeholder-shown:text-gray-400 peer-placeholder-shown:top-2 peer-focus:-top-3.5 peer-focus:text-gray-600 peer-focus:text-sm"
            >Message</label
          >
        </div>
        <button
